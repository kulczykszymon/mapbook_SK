...
users: list = [
    ...
    {'username': 'paweł' , 'location':'ostroda','posts':2,'usermessage':['życzenia2', 'kochamlegie2' , 'sprzedam opla', 'kiwi2']},
    {'username': 'eliza' , 'location':'radom','posts':3,'usermessage':['życzenia3', 'kochamlegie3']},
    {'username': 'filip' , 'location':'dęblin','posts':4,'usermessage':['życzenia4', 'kochamlegie4' , 'sprzedam opla', 'kiwi4']},
]
